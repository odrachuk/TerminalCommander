 ...
 * @author Drachuk O.V.
 */
public class NewTerminalSlider extends ViewGroup {
     ...
     */
    public NewTerminalSlider(Context context, AttributeSet attrs) {
     ...
     */
    public NewTerminalSlider(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(NewTerminalSlider.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(NewTerminalSlider.class.getName());
    }
