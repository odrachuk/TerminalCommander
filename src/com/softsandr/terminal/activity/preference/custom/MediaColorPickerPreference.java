 ...
 */
public class MediaColorPickerPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    public static final String DEFAULT_VALUE = "{\"red\":24,\"green\":168,\"blue\":24}";
